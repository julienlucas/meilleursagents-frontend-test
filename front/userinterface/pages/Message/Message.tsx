        ...
        <>
          ...
          {open && (
            <SMessage>
              <SMailContainer>
                <SMessageHeader>
                  {showCloseButton && <SCloseButton className="close" onClick={() => setOpen(false)}>X</SCloseButton>}
                  ...
                  <ul>
                    {selectedMessage?.contact?.email && (
                      <li>
                        <span><p>Email</p> <a href={`mailto:${selectedMessage?.contact?.email}`}>{selectedMessage?.contact?.email}</a></span>
                      </li>
                    )}
                    {selectedMessage?.contact?.phone && (
                      <li>
                        <span><p>Phone</p> <a href={`tel:${selectedMessage?.contact?.phone}`}>{selectedMessage?.contact?.phone}</a></span>
                      </li>
                    )}
                  </ul>
                </SMessageHeader>
                <SMessageBody>
                  ...
                  <p className="date">{moment(selectedMessage?.date).format('MMMM Do YYYY, h:mm a')}</p>
